...
public class Inventory{
    ...
    public static void cariBarang(HashMap<String, Integer> invetori, String barang){
        if (invetori.containsKey(barang)){
            System.out.println("Stok " + barang + ": " + invetori.get(barang) + " unit.");
        } else {
